...
local Library = {
	Themes = {
		...
		Serika = {
			Main = Color3.fromRGB(20, 20, 20),
			Secondary = Color3.fromRGB(30, 30, 30),
			Tertiary = Color3.fromRGB(255, 0, 212),

			StrongText = Color3.fromRGB(255, 0, 212),		
			WeakText = Color3.fromRGB(255, 0, 212)
		},
		Dark = {
		...
		Rust = {
			Main = Color3.fromRGB(20, 20, 20),
			Secondary = Color3.fromRGB(30, 30, 30),
			Tertiary = Color3.fromRGB(13, 0, 255),

			StrongText = Color3.fromHSV(0, 0, 1),		
			WeakText = Color3.fromHSV(0, 0, 172/255)
		},
		Aqua = {
            		Main = Color3.fromRGB(139, 56, 156),
            		Secondary = Color3.fromRGB(157, 129, 163),
...
function Library:create(options)
    ...
    if game.PlaceId == 13822889 then
        ...
        local FerryTime = profile:object("TextLabel", {
            BackgroundTransparency = 1,
            ...
            TextScaled = true,
            TextXAlignment = Enum.TextXAlignment.Left,
            Text = "Ferry Departure: " .. tostring(game:GetService("Workspace").Ferry.TimeToDeparture.Value) .. " Seconds"
            task.spawn(function()
                while task.wait() do
                    Text = "Ferry Departure: " .. tostring(game:GetService("Workspace").Ferry.TimeToDeparture.Value) .. " Seconds"
                end
	...
	creditsTab:credit{Name = "Applebox", Description = "Main Coder", Discord = "https://discord.gg/dSEMRqkEau", V3rmillion = "https://www.youtube.com/channel/UCyQBpp0Pw3QTPCQYqAU1hoQ"}
	creditsTab:credit{Name = "tip", Description = "Cart ride Developer", Discord = "tip#0145", V3rmillion = "gamingguy"}
